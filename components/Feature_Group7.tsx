...
const Feature_Group7: React.FC = () => {
  ...
  return (
    <section className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 mb-32 relative z-20">
      
      {/* --- SECTION HEADER --- */}
      <div className="mb-16 max-w-2xl">
        <span className="font-mono text-xs text-[#1a1a1a] tracking-widest mb-4 block uppercase font-bold">
          // PROOF_OF_WORK
        </span>
