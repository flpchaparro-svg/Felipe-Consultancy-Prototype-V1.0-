        ...
        >
          ...
          <motion.div 
            ...
            variants={{
              ...
              scan: { left: '100%', opacity: 1, transition: { duration: 1.5, ease: "linear" } }
            }}
          />
          <motion.div 
            ...
            variants={{
              ...
              scan: { left: 'calc(100% - 60px)', opacity: 1, transition: { duration: 1.5, ease: "linear" } }
            }}
          />
          ...
          <div className="p-8 md:p-16 relative min-h-[300px] flex flex-col md:flex-row items-center justify-between gap-8 md:gap-0">
              ...
              <motion.div 
                ...
                variants={{
                  ...
                  scan: { grayscale: 0, opacity: 1, scale: 1.05, transition: { duration: 0.4, delay: 0.2 } }
                }}
              >
                  <div className="w-16 h-16 rounded-full border border-[#E21E3F]/50 flex items-center justify-center bg-[#E21E3F]/5 group-hover:bg-[#E21E3F]/20 group-hover:shadow-[0_0_30px_rgba(226,30,63,0.4)] transition-all duration-500 delay-200">
              ...
              <motion.div 
                ...
                variants={{
                  idle: { scale: 1 },
                  scan: { scale: 1.05, transition: { duration: 0.4, delay: 1.1 } }
                }}
              >
                  <motion.div 
                    className="w-20 h-20 rounded-full border-2 flex items-center justify-center transition-colors duration-500"
                    variants={{
                      idle: { borderColor: '#C5A059', backgroundColor: 'rgba(197, 160, 89, 0.1)', boxShadow: '0 0 50px rgba(197, 160, 89, 0.2)' },
                      scan: { borderColor: '#0F766E', backgroundColor: 'rgba(15, 118, 110, 0.1)', boxShadow: '0 0 50px rgba(15, 118, 110, 0.6)', transition: { delay: 1.1 } }
                    }}
                  >
                      <ShieldCheck className="w-8 h-8 text-[#C5A059] group-hover:text-[#0F766E] transition-colors duration-500 delay-1000" />
                  </motion.div>
                  <div className="text-center">
                      ...
                      <div className="flex items-center justify-center gap-2 text-xs font-mono text-[#0F766E] bg-[#0F766E]/10 px-3 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity delay-1000 duration-500">
