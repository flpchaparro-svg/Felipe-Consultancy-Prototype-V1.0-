  ...
  return (
    <section id="origins" className="w-full bg-[#FFF2EC] py-32 px-6 md:px-12 lg:px-20 relative z-30 overflow-hidden border-t border-black/5">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
        ...
        {/* LEFT: THE PORTRAIT WITH SCAN ANIMATION */}
        <motion.div 
        ...
        >
          ...
          <div className="aspect-[4/5] bg-[#1a1a1a] relative overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
            <img 
        ...
        <div className="lg:col-span-7">
          ...
          <div className="space-y-6 max-w-xl">
            <p className="font-sans text-lg text-[#1a1a1a]/70 border-l-2 border-[#C5A059]/40 pl-8 leading-relaxed">
              Traditional agencies are bloated with project managers and account executives. You pay for their overhead, not your results.
            </p>
            <p className="font-sans text-lg text-[#1a1a1a]/70 leading-relaxed">
              I deliver the output of a full agency with the surgical focus of a single mind. I replace human friction with autonomous logic.
            </p>
          </div>
