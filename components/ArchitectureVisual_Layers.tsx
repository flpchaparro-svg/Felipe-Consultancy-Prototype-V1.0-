...
const ArchitectureVisual_Layers: React.FC = () => {
  ...
  // Range: 110px spacing (Expanded) down to 15px spacing (Stacked)
  ...
  const handleMouseLeave = () => {
    mouseY.set(0); // Reset to expanded view on leave
  };

  // Dimensions for the Isometric Rhombus
  const W = 260; 
  const H = 130; 
  ...
  const layers = [
    { 
      ...
      title: 'L1_INTERFACE', sub: 'The User' 
    },
    { 
      id: 'l2', y: y2, color: '#1a1a1a', 
      title: 'L2_AUTOMATION', sub: 'Event Bus // Logic' 
    },
    { 
      id: 'l3', y: y3, color: '#1a1a1a', 
      title: 'L3_INTELLIGENCE', sub: 'LLM // Inference' 
    },
    { 
      id: 'l4', y: y4, color: '#1a1a1a', 
      title: 'L4_DATA_KERNEL', sub: 'Postgres // Vector' 
    },
  ];
  ...
  return (
    ...
    >
      <svg width="100%" height="100%" viewBox="0 0 800 600" className="overflow-visible pointer-events-none">
        <defs>
           {/* Optional: Dot pattern if needed for backgrounds, though we are doing wireframes now */}
        ...
        <g transform="translate(400, 300)">
          ...
          {/* CENTRAL AXIS SPINE */}
          {/* Connects the center of Top Layer to Center of Bottom Layer */}
          <motion.line 
            x1="0" 
